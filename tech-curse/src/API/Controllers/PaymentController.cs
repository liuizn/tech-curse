...
using TechCurse.src.API.Middleware;
using TechCurse.src.Application.DTOs;
using TechCurse.src.Application.Features.Payments.Queries.GetPayments;
...
using TechCurse.src.Application.Features.Payments.Commands.CreatePayment;
using TechCurse.src.Application.Features.Payments.Commands.ProcessPayment;
using TechCurse.src.Application.Features.Payments.Commands.RefundPayment;
using MediatR;
